...
- [x] **Multiple location presets** — add preset configs for Hoboken, Jersey City, and NYC commuters with different default transit cards for each. Could be a first-run picker or a "Load preset" option in settings.
